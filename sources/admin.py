...
class PersonAdmin(admin.ModelAdmin):
    ...
    #     (, {}),
    # )
    fields = ['role', 'prefix', 'first_name', 'middle_name', 'last_name', 'type_of_expert', 'title', 'organization', 'website', 'expertise', 'email_address', 'phone_number_primary', 'phone_number_secondary', 'language', 'timezone', 'city', 'state', 'country', 'notes'] # 'location', 'woman', 'underrepresented', 'rating',
